...
app.post('/weather', function(req, res){
  const apikey = 'ed6e1836e5d9df68dd15510dbf78c494';
  ...
  https.get(url, function(response){
    ...
    response.on("data", function(data){
      ...
      const desc = weatherData.main.pressure;
      const sunset = Math.round(weatherData.sys.sunset);


      res.write("<h1> Country" + country + "city name: "+ name + "<br>")
      res.write("<h1> Current temperature is: " + temp )
      res.write("<br><br> The Humidity is: " + Humidity);
      res.write("<br><br> The pressure is: " + desc);
      res.write("<br><br> Sunset is at: " + sunset);
      res.send();
    }).on("error", (e) =>{
      console.log(e);
    })
